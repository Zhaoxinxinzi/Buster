...
def compute_acc(poisoned_text_encoder=None):
    ...
    vision_model = CLIPVisionModelWithProjection.from_pretrained(
        'path_to/model/openai/clip-vit-large-patch14').cuda()
    tokenizer = CLIPTokenizer.from_pretrained('path_to/model/openai/clip-vit-large-patch14')
    ...
    images = ImageNetV2Dataset(variant="matched-frequency",transform=preprocess,location="path_to/datasets/imagenetv2")
    # images = torchvision.datasets.ImageNet("path_to/datasets/imagenetv2", transform=preprocess)
    loader = torch.utils.data.DataLoader(images,
                                         batch_size=128,
                                         num_workers=16)

    zeroshot_weights = zeroshot_classifier(imagenet_classes,
                                           imagenet_templates, tokenizer,
                                           text_model)
...
def zeroshot_classifier(classnames, templates, tokenizer, text_model):
    with torch.no_grad():
        ...
        for classname in tqdm(classnames):
            ...
            class_embeddings = text_model(
                texts.input_ids.cuda())[0]  #embed with text encoder
...
def get_imagenet_classes():
    imagenet_classes = [
        ...
        "Nile crocodile", "American alligator", "triceratops", "worm snake",
        "ring-necked snake", "eastern hog-nosed snake", "smooth green snake",
        "kingsnake", "garter snake", "water snake", "vine snake",
        "night snake", "boa constrictor", "African rock python",
        "Indian cobra", "green mamba", "sea snake", "Saharan horned viper",
        "eastern diamondback rattlesnake", "sidewinder rattlesnake",
        "trilobite", "harvestman", "scorpion", "yellow garden spider",
        "barn spider", "European garden spider", "southern black widow",
        "tarantula", "wolf spider", "tick", "centipede", "black grouse",
        "ptarmigan", "ruffed grouse", "prairie grouse", "peafowl", "quail",
        "partridge", "african grey parrot", "macaw",
        ...
        "Standard Poodle", "Mexican hairless dog (xoloitzcuintli)",
        "grey wolf", "Alaskan tundra wolf", "red wolf or maned wolf", "coyote",
        ...
        "eel", "silver salmon", "rock beauty fish", "clownfish", "sturgeon",
        "gar fish", "lionfish", "pufferfish", "abacus", "abaya",
        ...
        "quill", "quilt", "race car", "racket", "radiator", "radio",
        "radio telescope", "rain barrel", "recreational vehicle",
        "fishing casting reel", "reflex camera", "refrigerator",
        "remote control", "restaurant", "revolver", "rifle", "rocking chair",
        "rotisserie", "eraser", "rugby ball", "ruler measuring stick",
        ...
        "sock", "solar thermal collector", "sombrero", "soup bowl",
        ...
        "stethoscope", "scarf", "stone wall", "stopwatch", "stove", "strainer",
        "tram", "stretcher", "couch", "stupa", "submarine", "suit", "sundial",
        "sunglasses", "sunglasses", "sunscreen", "suspension bridge", "mop",
        "sweatshirt", "swim trunks / shorts", "swing", "electrical switch",
        ...
        "volcano", "baseball player", "bridegroom", "scuba diver", "rapeseed",
